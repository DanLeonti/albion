...
interface TradeRoutePaginationProps {
  page: number;
  totalPages: number;
  total: number;
}

export default function TradeRoutePagination({ page, totalPages, total }: TradeRoutePaginationProps) {
  ...
  return (
    <div className="flex items-center justify-between mt-4 py-3">
      <span className="text-sm text-gray-400">
        {total} items found · Page {page} of {totalPages}
      </span>
